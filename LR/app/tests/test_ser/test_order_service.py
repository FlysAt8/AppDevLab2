...
class TestOrderService:
    ...
    async def test_create_order_success(self):
        ...
        mock_order_repo.create.return_value = Mock(
            id=1, user_id=1, address_id=None, product_id=1, quantity=1
        )
        ...
        order_data = OrderCreate(user_id=1, address_id=None, product_id=1, quantity=1)
    ...
    async def test_create_order_found_order(self):
        ...
        mock_order_repo.get_by_filter.return_value = Mock(
            id=1, user_id=1, address_id=None, product_id=1, quantity=1
        )
    ...
    async def test_create_order_not_quantity(self):
        ...
        mock_order_repo.get_by_filter.return_value = None
        mock_order_repo.create.return_value = Mock(
            id=1, user_id=1, address_id=None, product_id=1, quantity=2
        )
        ...
        order_data = OrderCreate(user_id=1, address_id=None, product_id=1, quantity=2)
